/*! angular-detour - v0.1.1 - 2013-06-02
...
StateBase.prototype.validateName = function(localName) {
  if (!isString(localName) || localName.indexOf('@') >= 0) {
...
StateBase.prototype.resetViews = function() {
  ...
  angular.forEach(isDefined(myViews) ? myViews : { '': state }, function (view, name) {
    if (name.indexOf('@') < 0) {
